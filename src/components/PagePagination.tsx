...
const PagePagination = ({pagination}: Props) => {
  ...
  const classNumberActive= "z-10 flex items-center justify-center px-3 h-8 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white";
      ...
      <ul className="inline-flex -space-x-px h-8 text-sm">
        <li>
          <Link
            ...
            className={cn(classPrevious, {"opacity-50 pointer-events-none" : page === 1,})}
          >
            Previous
        ...
        <li>
          <Link
            ...
            className={cn(classNext, {"opacity-50 pointer-events-none" : page === pageCount,})}
          >
            Next
          </Link>
        </li>
